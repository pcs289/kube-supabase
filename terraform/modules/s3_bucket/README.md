...
|------|-------------|------|---------|:--------:|
| <a name="input_bucket_encrypted"></a> [bucket\_encrypted](#input\_bucket\_encrypted) | Enable S3 Bucket Encryption | `bool` | `true` | no |
| <a name="input_bucket_name"></a> [bucket\_name](#input\_bucket\_name) | Globally Unique Bucket Name | `string` | n/a | yes |
| <a name="input_bucket_versioned"></a> [bucket\_versioned](#input\_bucket\_versioned) | Enable S3 Bucket Versioning | `bool` | `true` | no |
